...
public class StaggeredRecyclerViewHorizontal extends AppCompatActivity  implements OnRecyclerViewItemClick {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        StaggeredFruitAdapter fruitAdapter  = new StaggeredFruitAdapter(DataSource.icons);
