...
public class VerticalRecycelerView extends AppCompatActivity  implements OnRecyclerViewItemClick {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        listManifestoHorizontal = findViewById(R.id.recyclerviewvertical);
